export const events = [
  ...
  },
  {
    ...
    participants: [
      { id: 501, name: "Anonymous", avatar: "https://files.inparty.app/storage/user/photos/52911/small_IMG_4702-1716794387335.jpg" },
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    participants: [
      { id: 701, name: "MountainLover", avatar: "https://files.inparty.app/storage/user/photos/90696/small_A0490B73-F3E8-475D-A751-309DF3273286-1712130481189.jpg" },
    ],
  },
  {
    id: 8,
    ...
    participants: Array(100).fill(null).map((_, index) => ({
      id: 800 + index,
      name: `Dev${index + 1}`,
  ...
  },
  {
    ...
    participants: [
      { id: 901, name: "YogaFan", avatar: "https://files.inparty.app/storage/user/photos/5/small_IMG_3672-1713866265024.jpg" },
    ],
  },
  {
    id: 10,
